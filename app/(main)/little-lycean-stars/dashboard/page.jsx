...
import LittleLyceanStarsScoringModal from '@/app/modules/little-lycean-stars/ScoringModal'
import Footer from '@/app/modules/common/Footer'
import { ShinyButton } from '@/components/ui/shiny-button'

export default function LittleLyceanStarsScoringPage() {
  ...
  const fetchCandidates = async () => {
    try {
      setLoading(true)
      const { data } = await axios.get('/api/scoring/little-lycean-stars')
  ...
  const handleSignOut = () => {
    ...
    router.push('/little-lycean-stars')
  }
