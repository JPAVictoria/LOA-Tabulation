...
import LyceanTeenModelScoringModal from '@/app/modules/lycean-teen-model/ScoringModal'
import Footer from '@/app/modules/common/Footer'
import { ShinyButton } from '@/components/ui/shiny-button'

export default function LyceanTeenModelScoringPage() {
  ...
  const fetchCandidates = async () => {
    try {
      setLoading(true)
      const { data } = await axios.get('/api/scoring/lycean-teen-model')
