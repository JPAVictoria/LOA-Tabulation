...
import { SINGING_LOGIN_DATA } from '@/app/constants/singing/constants'

export default function SingingLoginPage() {
  ...
  const handleLogin = async ({ username, password }) => {
    ...
    try {
      ...
      if (response.data.success) {
        ...
        setTimeout(() => router.push('/singing/dashboard'), 1000)
      }
    } catch (error) {
  ...
  return (
    <div className='min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 flex'>
      <ImageSection data={SINGING_LOGIN_DATA} />
