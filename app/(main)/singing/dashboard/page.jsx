...
import SingingScoringModal from '@/app/modules/singing/ScoringModal'
import Footer from '@/app/modules/common/Footer'
import { ShinyButton } from '@/components/ui/shiny-button'

export default function SingingScoringPage() {
  ...
  const fetchCandidates = async () => {
    try {
      setLoading(true)
      const { data } = await axios.get('/api/scoring/singing')
