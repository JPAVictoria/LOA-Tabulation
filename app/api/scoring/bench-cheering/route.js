...
export async function GET() {
  try {
    ...
    // Get all judges assigned to BENCH_CHEERING competition
    const assignedJudges = await prisma.user.findMany({
      where: {
        assignedCompetition: 'BENCH_CHEERING',
        role: 'JUDGE',
        deleted: false
      },
      select: {
    ...
    // Get all criteria for BENCH_CHEERING
    ...
    console.error('Error fetching bench cheering candidates:', error)
...
export async function POST(request) {
  try {
    ...
    // Verify judge exists and is assigned to BENCH_CHEERING
    ...
    // Verify candidate exists and is in BENCH_CHEERING competition
    ...
    // Validate all criteria exist and belong to BENCH_CHEERING
